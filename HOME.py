...
with col1:
    ...
    # Expander must be moved out of column layout
    st.write("### A. DATA ASSEMBLY AND MANAGEMENT")

# Expander for A.1 SHAPEFILES (move outside columns)
...
# Other sections under DATA ASSEMBLY AND MANAGEMENT inside column layout
with col1:

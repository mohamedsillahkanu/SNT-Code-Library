...
// Create buttons dynamically and append to the body
const topRightDiv = document.createElement('div');
topRightDiv.classList.add('top-right-buttons');

// Create Step-by-step button
const stepByStepBtn = document.createElement('button');
stepByStepBtn.id = 'stepByStepBtn';
stepByStepBtn.textContent = 'Step by step approach';
topRightDiv.appendChild(stepByStepBtn);

// Create Full code button
const fullCodeBtn = document.createElement('button');
fullCodeBtn.id = 'fullCodeBtn';
fullCodeBtn.textContent = 'Full code';
topRightDiv.appendChild(fullCodeBtn);

// Append the button container to the body or specific element
document.body.appendChild(topRightDiv);

// Add CSS to position buttons (you can keep this in your CSS file)
...
document.getElementById('stepByStepBtn').addEventListener('click', function() {
    document.getElementById('stepByStepSection').scrollIntoView({ behavior: 'smooth' });
});

document.getElementById('fullCodeBtn').addEventListener('click', function() {
    document.getElementById('fullCodeSection').scrollIntoView({ behavior: 'smooth' });
});

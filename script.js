...
// Function to load content based on the menu clicked
function loadContent(section) {
    // Update the URL hash or query parameter
    window.history.pushState({}, '', `?section=${section}`);
    
    // Load content dynamically (this could be via AJAX or loading predefined HTML)
    document.getElementById('content').innerHTML = `<h1>${section} Content</h1>`;
}
...
// Load the content for the current URL on page load (if the section exists in the URL)
